...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Actualizar título
    document.title = `Orden de Compra {{ $nroControlFormateado }}`;
