...
<div class="card">
    ...
    <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="tasaDia" name="tasa" class="form-control" step="0.0001" min="0" required 
                               value="{{ isset($orden) ? number_format($orden->tasa, 4, '.', '') : '' }}" 
                               placeholder="0.0000">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="ivaNinguno" name="opcionIva" 
                                           value="ninguno" {{ (!isset($orden) || ($orden->aplicarIva == 0 && $orden->aplicarIvaDeduccion == 0)) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="ivaNormal" name="opcionIva" 
                                           value="normal" {{ isset($orden) && $orden->aplicarIva == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="ivaDeduccion" name="opcionIva" 
                                           value="deduccion" {{ isset($orden) && $orden->aplicarIvaDeduccion == 1 ? 'checked' : '' }}>
        ...
        {{-- 🔹 INPUT OCULTO PARA GUARDAR EL MODO DE CÁLCULO --}}
        <input type="hidden" id="modoCalculo" name="modo_calculo" value="{{ isset($orden) && $orden->modo_calculo == 'directo' ? '1' : '0' }}">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="observacion" name="observacion" class="form-control" rows="3" 
                              ...
                              maxlength="500">{{ isset($orden) ? $orden->observacion : '' }}</textarea>
                    ...
                    @if(isset($orden) && $orden->detalles->count() > 0)
                        ...
                        <tr id="fila_existente_{{ $detalle->id }}">
                            ...
                            <td>
                                ...
                                @if($detalle->modo_calculo === 0)
                                <small class="form-text text-muted subtotal-bs">
                                    ≈ {{ number_format($detalle->cantidad * $detalle->precio * $orden->tasa, 2, '.', '') }} Bs
                                </small>
                                @endif
                            </td>
                            <td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr class="table-info">
                                ...
                                <td class="text-right"><strong><span id="totalGeneralDolares">{{ isset($orden) ? number_format($orden->total_general, 2) : '0.00' }}</span></strong></td>
                            </tr>
                            
                            {{-- 🔹 MOSTRAR DIFERENTES CÁLCULOS DE IVA SEGÚN LA OPCIÓN --}}
                            ...
                            <tr id="infoModoCalculo">
                                ...
                                <td class="text-right">
                                    <small class="{{ isset($orden) && $orden->modo_calculo == 'directo' ? 'text-modo-directo' : 'text-modo-conversion' }}">
                                        {{ isset($orden) && $orden->modo_calculo == 'directo' ? 'Directo en BS' : 'Conversión USD → BS' }}
                                    </small>
                                </td>
                            </tr>
                        ...
                        <tfoot>
                            <tr class="table-info">
                                ...
                                <th id="totalOrdenDinamicaDolares">
                                    {{ isset($orden) ? number_format($orden->total_general, 2) : '0.00' }}
                                </th>
                                <th></th>
                            </tr>
                            <tr class="table-success">
                                ...
                                <th id="totalOrdenDinamicaBs">
                                    {{ isset($orden) ? number_format($orden->total_bs, 2) : '0.00' }}
                                </th>
                                <th></th>
                            </tr>
                        </tfoot>
...
$('#btnGuardarCompleto').click(async function() {
        ...
        if (response.ok && resultado.success) {
            ...
            Swal.fire({
                ...
                if (modoEdicion) {
                    ...
                    window.location.href = `{{ url('/orden-compras/plantilla/') }}/${ordenId}`;
                }
            });
        } else {
   ...
   function calcularTotalOrdenDinamica() {
    ...
    $('#btnVerOrden').click(function() {
        if (ordenId) {
            window.open(`{{ url('/orden-compras/plantilla/') }}/${ordenId}`, '_blank');
        }
    });
    ...
    $('#btnImprimirOrden').click(function() {
        if (ordenId) {
            window.open(`{{ url('/orden-compras/plantilla/') }}/${ordenId}/imprimir`, '_blank');
        }
    });
