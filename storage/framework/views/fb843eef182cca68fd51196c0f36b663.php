            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody id="tbody-proveedores">
                        <?php echo $__env->make('proveedor.partials.tabla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </tbody>
                </table>
            </div>

            <div class="mt-3" id="pagination-container">
                <?php echo e($proveedor->links()); ?>
...
$(document).ready(function() {
    ...
    const URLS = {
        listar: "<?php echo e(route('proveedor.listar')); ?>",
        obtener: baseUrl + "/proveedor/obtener/",
        ver: baseUrl + "/proveedor/ver/",
        guardar: "<?php echo e(route('proveedor.guardar')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/proveedor/proveedor.blade.php ENDPATH**/ ?>