...
<?php $__env->startSection('content_header'); ?>
      <h1><?php echo e(config('app.tipo_documento', 'Órdenes de Compra')); ?></h1>
    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <div class="btn-group" role="group" aria-label="Botones de acciones">
                <a href="<?php echo e(route('ordenes.crear')); ?>" class="btn btn-primary btn-sm mr-2">
...
<?php echo $__env->make('Modal.vista', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/modal-vista.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/css/menuorde.css')); ?>">
...
$(document).ready(function() {
    ...
    var globalmetodos = <?php echo json_encode($metodos, 15, 512) ?>;
...
<script>
        ...
        var globalUnidades = <?php echo json_encode($unidades, 15, 512) ?>;
...
<script src="<?php echo e(asset('assets/js/modal-vista.js')); ?>"></script>
...
window.csrfToken = '<?php echo e(csrf_token()); ?>';
 ...
 const prefijoControl = <?php echo json_encode(env('PREFIJO_CONTROL', 'CZ'), 512) ?>;
    ...
    $(document).ready(function() {
        ...
        function formatoNumeroControl(numero) {
            ...
            // Remover cualquier prefijo del inicio (dinámico)
            var regex = new RegExp('^' + prefijoControl + '\\s*', 'i');
            numeroStr = numeroStr.replace(regex, '');
            ...
            var numeroFormateado = prefijoControl + numeroStr.padStart(6, '0');
    ...
    window.ordersTable = $('#ordersTable').DataTable({
        ...
        serverSide: false,
        ajax: {
            url: '<?php echo e(route("ordenes-compras.datos")); ?>',
            type: 'GET',
            dataSrc: 'data',
    ...
    $('#btnActualizarTasa').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '<?php echo e(route("actualizar.tasas")); ?>',
                    type: 'GET',
                    data: {
...
function enviarDatosAGestionOrdenes(orderId, responsable, numeroDocumento, fechaFactura, tipoFactura, metodoPagoId, codigoReferencia, nuevoEstatus) {
    var url = '<?php echo e(route("ordenes.gestion")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/orden_compra/menu.blade.php ENDPATH**/ ?>