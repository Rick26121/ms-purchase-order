    ...
    <a href="/ordenes/menu" style="text-decoration: none; color: inherit;">
      <div class="info-box bg-gradient-info">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo e(number_format($totalOrdenes)); ?></span>
          <div class="progress">
            <div class="progress-bar" style="width: <?php echo e($porcentajeordenes['porcentaje_pendientes']); ?>%"></div>
          </div>
          <span class="progress-description">
            <i class="fas fa-clock"></i> Hoy: <?php echo e(number_format($ordenesHoy)); ?> nuevas
          </span>
        </div>
      </div>
    </a>
  ...
  <div class="col-md-6 col-lg-3 mb-3">
    <div class="info-box bg-gradient-success" style="cursor: pointer;" onclick="window.location.href='/proveedor';">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number"><?php echo e(number_format($proveedores)); ?></span>
        <div class="progress">
...
</div><?php /**PATH /var/www/html/resources/views/home.blade.php ENDPATH**/ ?>