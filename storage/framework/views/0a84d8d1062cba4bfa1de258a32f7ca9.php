...
<?php $__env->startSection('title', 'Buscar Órdenes por Fecha'); ?>
...
<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?php echo e(route('ordenes.hoy')); ?>" class="btn btn-sm btn-outline-primary">
                <i class="fas fa-calendar-day mr-1"></i> Ver Hoy
            </a>
            <a href="<?php echo e(route('reportes.menu')); ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card card-primary">
                ...
                <form action="<?php echo e(route('ordenes.fechas')); ?>" method="POST" id="formBusqueda">
                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="fechaInicioPicker">
                                                <input type="date" 
                                                       ...
                                                       id="fecha_inicio" 
                                                       name="fecha_inicio" 
                                                       value="<?php echo e($fechaHoy ?? date('Y-m-d')); ?>"
                                                       required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/reportes/buscar-fechas.blade.php ENDPATH**/ ?>