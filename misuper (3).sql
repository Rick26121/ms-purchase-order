...
-- Tiempo de generación: 17-10-2025 a las 21:02:43
...
('laravel-cache-690e53206f9d442723940c36137504b3', 'i:1;', 1760727286),
('laravel-cache-690e53206f9d442723940c36137504b3:timer', 'i:1760727286;', 1760727286),
('laravel-cache-99a5c77bb2811fcd296fd4b9772c35e2', 'i:1;', 1760731904),
('laravel-cache-99a5c77bb2811fcd296fd4b9772c35e2:timer', 'i:1760731904;', 1760731904);
...
CREATE TABLE `ordenes_compras` (
  ...
  `usuario` bigint UNSIGNED NOT NULL DEFAULT '2',
...
INSERT INTO `ordenes_compras` (`id`, `sucursal`, `producto`, `proveedores`, `cantidad`, `unidad`, `totalGeneral`, `tasa_dia`, `moneda`, `iva`, `totalbs`, `usuario`, `created_at`, `updated_at`, `fecha_orden`, `estatus`, `visible`) VALUES
(6, 4, 7, 24, 1, 17, 33.00, 203.74, 'usd', 0, 6723.42, 1, '2025-10-17', '2025-10-17', '2025-10-17', 0, 1),
(7, 6, 9, 24, 300, 12, 29550.00, 203.74, 'usd', 0, 6020517.00, 2, '2025-10-17', '2025-10-17', '2025-10-17', 0, 1);
...
(6, 'fghfghfh', 20.00, '2025-10-16', '2025-10-16'),
(7, 'sss', 33.00, '2025-10-17', '2025-10-17'),
(8, 'sss', 33.00, '2025-10-17', '2025-10-17'),
(9, 'cable de fibra', 98.50, '2025-10-17', '2025-10-17');
...
(1, 'ricardo Zambrano', 'ricardo26121@gmail.com', NULL, '$2y$12$cAhV/0feksMa0gvWZoOiaeqqEcrmC3XQfCA5kHR6dVuvjbLvZDwL6', NULL, '2025-10-16 00:47:02', '2025-10-16 00:47:02'),
(2, 'Dany El arabe', 'sistemamisuper1@gmail.com', NULL, '$2y$12$acbqpkGf3frIj3Y.L/yVs.5SbjFI0P.qGU9FfPOf.HxBnYknz7Xc.', NULL, '2025-10-17 22:35:02', '2025-10-17 22:35:02');
...
ALTER TABLE `ordenes_compras`
  ...
  ADD CONSTRAINT `usuarios-ordenes` FOREIGN KEY (`usuario`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
