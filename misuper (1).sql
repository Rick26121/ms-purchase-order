...
-- Tiempo de generación: 10-10-2025 a las 20:50:08
...
CREATE TABLE `ordenes_compras` (
  ...
  `moneda` varchar(25) COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `ordenes_compras` (`id`, `sucursal`, `producto`, `proveedores`, `cantidad`, `unidad`, `totalGeneral`, `tasa_dia`, `moneda`, `iva`, `totalbs`, `created_at`, `updated_at`, `fecha_orden`) VALUES
(1, 1, 3, 21, 22, 1, 22.00, 193.30, 'usd', 0, 4252.60, '2025-10-10', '2025-10-10', '2025-10-10'),
(2, 1, 3, 21, 22, 1, 22.00, 193.30, 'usd', 0, 4252.60, '2025-10-10', '2025-10-10', '2025-10-10'),
(3, 1, 4, 22, 1, 1, 5.00, 193.30, 'usd', 1, 1121.14, '2025-10-10', '2025-10-10', '2025-10-10');
