...
-- Tiempo de generación: 09-10-2025 a las 20:17:09
...
CREATE TABLE `cuentas_bancarias` (
  ...
  `tipo_cuenta` varchar(50) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `numero_cuenta` varchar(30) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `correo_asociado` varchar(150) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `titular` varchar(150) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `cedula` varchar(20) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `banco` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL
...
CREATE TABLE `ordenes_compras` (
  ...
  `producto` varchar(50) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `cantidad` int NOT NULL,
  `precio` decimal(10,2) NOT NULL,
  `unidad` int NOT NULL,
  `totalGeneral` decimal(10,2) NOT NULL,
  `tasa_dia` decimal(10,2) NOT NULL,
  `toalbs` decimal(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
CREATE TABLE `pagos_moviles` (
  ...
  `id_proveedor` int NOT NULL,
  `banco` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `rif_asociado` varchar(20) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `proveedores` (
  ...
  `correo` varchar(150) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
